...
@section('konten')
    ...
    <div> <a href="{{ route('jabatan.tambah') }}"><button type="button" class="btn btn-outline-primary"><i
                        ...
                        <td>
                            <div class="input-group mb-3">
                                <span class="input-group-text border-0">
                                    <a href="{{ route('jabatan.edit', $jabatan->id) }}" class="btn btn-warning"><i
                                            class="fa fa-pencil" aria-hidden="true"></i>Edit</a>
                                </span><span class="input-group-text border-0">
                                    <form onsubmit="return confirm('Data jabatan akan dihapus ?')"
                                        action=" {{ route('jabatan.deleteJabatan', $jabatan->id) }}" method="POST" ">
                            @csrf
                            @method('DELETE')
